...
vendorfile = "Items_List.csv"
itemsDict = {}

"""
itemsDict keys are skus corresponding to a list of:
...
with open(vendorfile, 'r') as f:
    for line in f:
        line = line.split(',"""",')
        itemsDict[line[0]] = [line[1], float(line[2]), float(line[3]), line[4], line[5].strip()]
